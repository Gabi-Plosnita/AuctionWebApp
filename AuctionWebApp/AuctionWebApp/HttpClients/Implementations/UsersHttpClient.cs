...
public class UsersHttpClient : BaseHttpClient, IUsersHttpClient
{
	...
	public async Task<Result> CreateConnectedAccountAsync(CreateConnectedStripeAccountRequest createConnectedAccountRequest)
		=> await SendRequestAsync("api/users/create-connected-account", HttpMethod.Post, createConnectedAccountRequest);
	...
	public async Task<Result> CreateCustomerAccountAsync(CreateStripeCustomerAccountRequest createStripeCustomerAccountRequest)
		=> await SendRequestAsync("api/users/create-customer-account", HttpMethod.Post, createStripeCustomerAccountRequest);
}
